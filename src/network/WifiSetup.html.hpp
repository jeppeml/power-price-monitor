  ...
  <body>
            ...
            <td>
              <div class="slider-container">
                ...
                <input
                  ...
                  name="priceHigh"
                  value="1.00"
                  oninput="updateSliderValue('highValue', this.value)"
                />
              </div>
            </td>
            <td>
            ...
            <td>
              <div class="slider-container">
                ...
                <input
                  ...
                  name="summerLow"
                  value="0.14"
                  oninput="updateSliderValue('summerLowValue', this.value)"
                />
              </div>
            </td>
          </tr>
            ...
            <td>
              <div class="slider-container">
                ...
                <input
                  ...
                  name="summerMedium"
                  value="0.21"
                  oninput="updateSliderValue('summerMediumValue', this.value)"
                />
              </div>
            </td>
          </tr>
            ...
            <td>
              <div class="slider-container">
                ...
                <input
                  ...
                  name="summerHigh"
                  value="0.54"
                  oninput="updateSliderValue('summerHighValue', this.value)"
                />
              </div>
            </td>
          </tr>
            ...
            <td>
              <div class="slider-container">
                ...
                <input
                  ...
                  name="winterLow"
                  value="0.14"
                  oninput="updateSliderValue('winterLowValue', this.value)"
                />
              </div>
            </td>
          </tr>
            ...
            <td>
              <div class="slider-container">
                ...
                <input
                  ...
                  name="winterMedium"
                  value="0.41"
                  oninput="updateSliderValue('winterMediumValue', this.value)"
                />
              </div>
            </td>
          </tr>
            ...
            <td>
              <div class="slider-container">
                ...
                <input
                  ...
                  name="winterHigh"
                  value="1.24"
                  oninput="updateSliderValue('winterHighValue', this.value)"
                />
              </div>
            </td>
          </tr>
    ...
    <script>
      ...
      function setLanguage(lang) {
        ...
        document.getElementById("pageTitleHeader").innerText =
          translation.pageTitleHeader;
        document.getElementById("labelSSID").innerText = translation.labelSSID;
        document.getElementById("labelPassword").innerText =
          translation.labelPassword;
        document.getElementById("labelRoom").innerText = translation.labelRoom;
        document.getElementById("submitButton").value =
          translation.submitButton;
        document.getElementById("colorSettingsTitle").innerText =
          translation.colorSettingsTitle;
        document.getElementById("tariffSectionTitle").innerText =
          translation.tariffSectionTitle;

        // Update tariff labels
        document.getElementById("labelSummerLow").innerText =
          translation.labelSummerLow;
        document.getElementById("labelSummerMedium").innerText =
          translation.labelSummerMedium;
        document.getElementById("labelSummerHigh").innerText =
          translation.labelSummerHigh;
        document.getElementById("labelWinterLow").innerText =
          translation.labelWinterLow;
        document.getElementById("labelWinterMedium").innerText =
          translation.labelWinterMedium;
        document.getElementById("labelWinterHigh").innerText =
          translation.labelWinterHigh;
      }
